@extends('layouts.master', ['title' => 'Join Our Network'])
...
@section('content')
    <section id="slider" class="slider-element bg-color">
        <div class="container mt-4" style="z-index: 2">
            <div class="center">
                <h2 class="text-blue h2 fw-semibold mb-2">Sign Up For Moving Leads</h2>
                <p class="text-blue">Sign up below and an account representative will contact you shortly.</p>
            </div>
                        ...
                        <div class="tab-pane fade show active" id="home-moving" role="tabpanel"
                            ...
                            <div class="">
                                ...
                                <form class="row others-moving-form position-relative mb-0"
                                    action="{{ route('postjoinournetwork') }}" method="POST">
                                    @csrf
                                    @if ($errors->any())
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="{{ old('name') }}"
                                                class="form-control mb4 required" id="name" placeholder="Name"
                                                name="name" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            <span class="input-group-text bg-transparent"><i class="fa-solid fa-building"></i></span>
                                            <input type="text" value="{{ old('company') }}"
                                                class="form-control mb4 required" id="company" placeholder="Company"
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="{{ old('email') }}"
                                                class="form-control mb4 required" id="email" placeholder="Email"
                                                name="email" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="number" value="{{ old('phonenumber') }}"
                                                class="form-control mb4 required" id="phonenumber" placeholder="Phone Number"
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            <span class="input-group-text bg-transparent"><i class="fa-sharp fa-solid fa-flag-usa"></i></span>
                                            <select name="state" id="state" class="form-control mb4 required">
