@extends('layouts.master', ['title' => 'Know your Rights'])
            ...
            <div class="py-6 dark" style="background-color: #061a35;">
                <div class="container mb-5">
                    <div class="row justify-content-between">
                        <div class="col-lg-12">
                            <p><strong>All you Need to Know About Your Moving Rights</strong></p>
                            <p>Everyone who has ever used a moving company has had different experiences, some good and some bad. A lack of basic knowledge of your moving rights can often be blamed for the bad experiences. The Federal Motor Carrier Safety Administration (FMCSA) has created a booklet that contains all your moving rights and responsibilities.<span class="Apple-converted-space">&nbsp;</span></p>
                            <p>The moving company you decide to select for your move is obligated to present you with this booklet. It&rsquo;s now your responsibility to read and understand the contents of the book.<span class="Apple-converted-space">&nbsp;</span></p>
                            <p>The book contains information about the insurance your mover covers, the different kinds of estimates, and what they entail (binding and non-binding), among other things. If a mover doesn&rsquo;t hand you this booklet, they are breaking federal laws and could face the repercussions of the law.</p>
                            <p><strong>The Moving Company</strong></p>
                            <p>There are two moving insurance types that movers can provide for you; one is full value protection insurance, and the other is Release Value Insurance for 60 cents an article. An understanding of the difference between these two insurance types can save you the stress of arguing with your mover at the end of the move. Though both of them look similar in terms of what they offer, they are entirely different.<span class="Apple-converted-space">&nbsp;</span></p>
                            <p>Movers end up charging customers extra when they get to their destination for different reasons. Sometimes these extra charges are ridiculous, other times, they might be legitimate, but the only way to curb this is to ask the movers to inform you of the different forms of payment they&rsquo;ll make available at the point of drop off.<span class="Apple-converted-space">&nbsp;</span></p>
                            <p>Make sure you and the mover agree and sign a binding estimate rather than a non-binding estimate because you can pay up to 10% extra if it&rsquo;s non-binding. Binding estimates place a cuff on the hands of your movers and limit their ability to charge you illegally.</p>
                            <p><strong>Filing Claims and the FMCSA<span class="Apple-converted-space">&nbsp;</span></strong></p>
                            <p>When issues arise between you and the moving company you selected, FMCSA does not have the power to file a court case or assist you in any way. The only thing they can do is arm you with information which they have done in the booklet movers are supposed to give before the move. In the book, they stated clearly that you could file a claim against your mover within 9 months if you suffer any losses or damages during the move. If you wait until after 9 months, the moving company has the right to ignore your claim.<span class="Apple-converted-space">&nbsp;</span></p>
                            <p>Before you move, ensure you read the entire booklet presented to you by the shipping company because it has all the information you may need.<span class="Apple-converted-space">&nbsp; </span>From the Bill of lading requirement to delivery receipt, all your rights are detailed in the handbook.<span class="Apple-converted-space">&nbsp;</span></p>
