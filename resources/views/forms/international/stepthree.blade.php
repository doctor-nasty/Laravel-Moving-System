                    ...
                    <div class="tab-content rounded-bottom shadow bg-white py-4 px-5">
                        <div class="tab-pane fade show active" id="home-moving" role="tabpanel"
                            ...
                            <p class="mb-4">Moving Details:</p>
                                ...
                                <form action="{{ route('internationalForm.create.step.three.post') }}"
                                method="post">
                                {{ csrf_field() }}
                                        <table class="table">
                                            <tr>
                                                <td class="mb4">Moving From:</td>
                                                <td class="mb4">{{ $forms->intl_fr_zip }}</td>
                                            </tr>
                                            <tr>
                                                <td class="mb4">Moving To:</td>
                                                <td class="mb4">{{ $forms->intl_to_cntr }}, {{ $forms->intl_to_cont }}</td>
                                            </tr>
                                            <tr>
                                                <td class="mb4">Moving Date:</td>
                                                <td class="mb4">{{ $forms->intl_dt }}</td>
                                            </tr>
                                            <tr>
                                                <td class="mb4">Move Size:</td>
                                                <td class="mb4">{{ $forms->intl_sz_id }}</td>
                                            </tr>
                                        </table>

                                    <div class="card-footer text-right">
                                        <button type="submit"
                                            class="btn bg-color text-white fw-medium w-100 py-2 mt-2">Submit</button>
                                    </div>
                            </form>
