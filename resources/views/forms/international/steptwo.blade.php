            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <ul class="nav nav-tabs nav-justified flex-column border-bottom-0 flex-md-row bg-color mt-4"
                        role="tablist">
                        <li class="nav-item">
                            <a class="nav-link py-3 active" id="home-moving-tab" data-bs-toggle="tab" href="#international"
                                role="tab" aria-controls="home-moving" aria-selected="true">International</a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane fade show active" id="home-moving" role="tabpanel"
                            ...
                            <div class="">
                                ...
                                <form class="row others-moving-form position-relative mb-0"
                                    action="{{ route('internationalForm.create.step.two.post') }}" method="POST">
                                    @csrf
                                    @if ($errors->any())
                                        <div style="margin-bottom: 10px; color:red;">
                                            <ul>
                                                @foreach ($errors->all() as $error)
                                                    <li class="mb4">{{ $error }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    @endif
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="{{ old('intl_fnm') }}"
                                                class="form-control mb4 required" id="intl_fnm" placeholder="First Name"
                                                name="intl_fnm" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            <span class="input-group-text bg-transparent"><i
                                                    class="fa-solid fa-user"></i></span>
                                            <input type="text" value="{{ old('intl_lnm') }}"
                                                class="form-control mb4 required" id="intl_lnm" placeholder="Last Name"
                                                name="intl_lnm" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="{{ old('intl_email') }}"
                                                class="form-control mb4 required" id="intl_email" placeholder="Email"
                                                name="intl_email" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="number" value="{{ old('intl_tel') }}"
                                                class="form-control mb4 required" id="intl_tel"
                                                placeholder="Phone Number" name="intl_tel" required>
                                        </div>
                                    </div>
                                    ...
                                    @endphp
                                    <input type="hidden" name="intl_tkn" id="intl_tkn" value="{{ $pin }}">

                                    <div class="card-footer text-right">
                                        <button type="submit"
                                            class="btn bg-color text-white fw-medium w-100 py-2 mt-2">Next</button>
                                    </div>
