                ...
                <div class="col-lg-6">
                    ...
                    <div class="tab-content rounded-bottom shadow bg-white py-4 px-5">
                        <div class="tab-pane fade show active" id="home-moving" role="tabpanel"
                            ...
                            <form action="{{ route('internationalForm.verify.post') }}" method="post">
                                {{ csrf_field() }}
                                @if ($errors->any())
                            ...
                            @endif
                                ...
                                <div class="col-lg-6 form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control required" placeholder="Enter PIN" id="pin" name="pin" value="" required>
                                    </div>
                                </div>
