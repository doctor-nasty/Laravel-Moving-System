                    ...
                    <ul class="nav nav-tabs nav-justified flex-column border-bottom-0 flex-md-row bg-color mt-4"
                        ...
                        <li class="nav-item">
                            <a class="nav-link py-3 active" id="home-moving-tab" data-bs-toggle="tab" href="#home-moving"
                                role="tab" aria-controls="home-moving" aria-selected="true">Interstate</a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane fade show active" id="home-moving" role="tabpanel"
                            ...
                            <div class="">
                                ...
                                <form class="row others-moving-form position-relative mb-0"
                                    action="{{ route('interstateForm.create.step.two.post') }}" method="POST">
                                    @csrf
                                    @if ($errors->any())
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="{{ old('inst_fnm') }}"
                                                class="form-control mb4 required" id="inst_fnm" placeholder="First Name"
                                                name="inst_fnm" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            <span class="input-group-text bg-transparent"><i
                                                    class="fa-solid fa-user"></i></span>
                                            <input type="text" value="{{ old('inst_lnm') }}"
                                                class="form-control mb4 required" id="inst_lnm" placeholder="Last Name"
                                                name="inst_lnm" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="{{ old('inst_email') }}"
                                                class="form-control mb4 required" id="inst_email" placeholder="Email"
                                                name="inst_email" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="number" value="{{ old('inst_tel') }}"
                                                class="form-control mb4 required" id="inst_tel"
                                                placeholder="Phone Number" name="inst_tel" required>
                                        </div>
                                    </div>
                                    ...
                                    @endphp
                                    <input type="hidden" name="inst_tkn" id="inst_tkn" value="{{ $pin }}">
