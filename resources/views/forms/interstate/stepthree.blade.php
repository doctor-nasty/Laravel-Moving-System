                    ...
                    <div class="tab-content rounded-bottom shadow bg-white py-4 px-5">
                        <div class="tab-pane fade show active" id="home-moving" role="tabpanel"
                            ...
                            <p class="mb-4">Moving Details:</p>
                                ...
                                <form action="{{ route('interstateForm.create.step.three.post') }}"
                                method="post">
                                {{ csrf_field() }}
                                        <table class="table">
                                            <tr>
                                                <td class="mb4">Moving From:</td>
                                                <td class="mb4">{{ $cityfrom }}, {{ $forms->inst_fr_zip }}</td>
                                            </tr>
                                            <tr>
                                                <td class="mb4">Moving To:</td>
                                                <td class="mb4">{{ $cityto }}, {{ $forms->inst_to_zip }}</td>
                                            </tr>
                                            <tr>
                                                <td class="mb4">Moving Date:</td>
                                                <td class="mb4">{{ $forms->inst_dt }}</td>
                                            </tr>
                                            <tr>
                                                <td class="mb4">Move Size:</td>
                                                <td class="mb4">{{ $mvsz }}</td>
                                            </tr>
                                            <tr>
