                    ...
                    <div class="tab-content rounded-bottom shadow bg-white py-4 px-5">
                        <div class="tab-pane fade show active" id="home-moving" role="tabpanel"
                            ...
                            <p class="mb-4">Moving Details:</p>
                                ...
                                <form action="{{ route('storageForm.create.step.three.post') }}"
                                method="post">
                                {{ csrf_field() }}
                                        <table class="table">
                                            <tr>
                                                <td class="mb4">Storage ZIP:</td>
                                                <td class="mb4">{{ $storagezip }}, {{ $forms->strg_zip }}</td>
                                            </tr>
                                            <tr>
                                                <td class="mb4">Moving Date:</td>
                                                <td class="mb4">{{ $forms->strg_dt }}</td>
                                            </tr>
                                            <tr>
                                                <td class="mb4">Move Size:</td>
                                                <td class="mb4">{{ $forms->strg_sz_id }}</td>
                                            </tr>
                                        </table>
