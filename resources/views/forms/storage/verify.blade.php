            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <ul class="nav nav-tabs nav-justified flex-column border-bottom-0 flex-md-row bg-color mt-4"
                        role="tablist">
                        <li class="nav-item">
                            <a class="nav-link py-3 active" id="storage-tab" data-bs-toggle="tab" href="#storage"
                                role="tab" aria-controls="storage" aria-selected="true">Storage</a>
                        </li>
                    </ul>
                    <div class="tab-content rounded-bottom shadow bg-white py-4 px-5">
                        <div class="tab-pane fade show active" id="storage" role="tabpanel"
                            ...
                            <form action="{{ route('storageForm.verify.post') }}" method="post">
                                {{ csrf_field() }}
                                @if ($errors->any())
                            ...
                            <div class="col-lg-6 form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control required" placeholder="Enter PIN" id="pin" name="pin" value="">
                                    </div>
                                </div>
