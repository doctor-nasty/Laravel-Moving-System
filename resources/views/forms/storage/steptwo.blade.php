                        ...
                        <div class="tab-pane fade show active" id="home-moving" role="tabpanel"
                            ...
                            <div class="">
                                ...
                                <form class="row others-moving-form position-relative mb-0"
                                    action="{{ route('storageForm.create.step.two.post') }}" method="POST">
                                    @csrf
                                    @if ($errors->any())
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="{{ old('strg_fnm') }}"
                                                class="form-control mb4 required" id="strg_fnm" placeholder="First Name"
                                                name="strg_fnm" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            <span class="input-group-text bg-transparent"><i
                                                    class="fa-solid fa-user"></i></span>
                                            <input type="text" value="{{ old('strg_lnm') }}"
                                                class="form-control mb4 required" id="strg_lnm" placeholder="Last Name"
                                                name="strg_lnm" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="{{ old('strg_email') }}"
                                                class="form-control mb4 required" id="strg_email" placeholder="Email"
                                                name="strg_email" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="number" value="{{ old('strg_tel') }}"
                                                class="form-control mb4 required" id="strg_tel"
                                                placeholder="Phone Number" name="strg_tel" required>
                                        </div>
                                    </div>
                                    ...
                                    @endphp
                                    <input type="hidden" name="strg_tkn" id="strg_tkn" value="{{ $pin }}">
