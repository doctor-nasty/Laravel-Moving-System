            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <ul class="nav nav-tabs nav-justified flex-column border-bottom-0 flex-md-row bg-color mt-4"
                        role="tablist">
                        <li class="nav-item">
                            <a class="nav-link py-3 active" id="home-moving-tab" data-bs-toggle="tab" href="#carshipping"
                        ...
                        <div class="tab-pane fade show active" id="home-moving" role="tabpanel"
                            ...
                            <div class="">
                                ...
                                <form class="row others-moving-form position-relative mb-0"
                                    action="{{ route('carForm.create.step.two.post') }}" method="POST">
                                    @csrf
                                    @if ($errors->any())
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="{{ old('carshptl_fnm') }}"
                                                class="form-control mb4 required" id="carshp_fnm" placeholder="First Name"
                                                name="carshp_fnm" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            <span class="input-group-text bg-transparent"><i
                                                    class="fa-solid fa-user"></i></span>
                                            <input type="text" value="{{ old('carshp_lnm') }}"
                                                class="form-control mb4 required" id="carshp_lnm" placeholder="Last Name"
                                                name="carshp_lnm" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="{{ old('carshp_email') }}"
                                                class="form-control mb4 required" id="carshp_email" placeholder="Email"
                                                name="carshp_email" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="number" value="{{ old('carshp_tel') }}"
                                                class="form-control mb4 required" id="carshp_tel"
                                                placeholder="Phone Number" name="carshp_tel" required>
                                        </div>
                                    </div>
                                    ...
                                    @endphp
                                    <input type="hidden" name="carshp_tkn" id="carshp_tkn" value="{{ $pin }}">
