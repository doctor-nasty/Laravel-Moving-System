                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control form-control-user @error('name') is-invalid @enderror"
                                id="Name" placeholder="Company Name" name="name" value="{{ old('name') }}">
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            <input type="text"
                                class="form-control form-control-user @error('fleetsize') is-invalid @enderror" id="Fleetsize"
                                placeholder="Fleetsize" name="fleetsize" value="{{ old('fleetsize') }}">
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control form-control-user @error('zip') is-invalid @enderror"
                                id="Zip" placeholder="Zip" name="zip" value="{{ old('zip') }}">
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            <input type="text"
                                ...
                                id="USDOT" placeholder="US DOT" name="usdot" value="{{ old('usdot') }}">
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            <input type="text"
                                class="form-control form-control-user @error('mcno') is-invalid @enderror" id="MCNO"
                                placeholder="MC NO" name="mcno" value="{{ old('mcno') }}">
